        ...
        methods: {
            ...
            getBody(order){
                            ...
                            [
                                {
                                    columns:[
                                        [
                                            {text:'发货人：'+order.orderCustomer.send_name,style:'table'},
                                            {text:'电话：',style:'table'},
                                        ],
                                        [
                                            {text:'单位',style:'table'},
                                            {text:'手机'+order.orderCustomer.send_phone,style:'table'},
                                        ]
                                    ]
                                },
                                {text:'地址：'+order.orderCustomer.send_addr + ' ' + order.orderCustomer.send_addr_info,style:'table'},
                            ],
                        ],
                        colSpan: 6
                    },
                ...
                bodyarry.push([
                    ...
                    {text:'重量',style:'table'},
                    {text:'体积',style:'table'},
                    {text:'计费方式',style:'table'},
                    {text:'运费',style:'table'},
                    {text:'包装费',style:'table'},
                    {text:'声明价值',style:'table'},
                    {text:'保险费',style:'table'},
                ...
                order.orderGoods.forEach(function(value, index, array) {
                    bodyarry.push([
                        ...
                        {text:'',style:'table'},
                        {text:value.freight,style:'table'},
                        {text:'',style:'table'},
                        {text:'',style:'table'},
                        {text:'',style:'table'},
                        {text:'',style:'table'}]);
                ...
                bodyarry.push([
                    {text:'合计',style:'table'},
                    {text:'',style:'table'},
                    {text:number,style:'table'},
                    {text:weight,style:'table'},
                    {text:'',style:'table'},
                    {text:'',style:'table'},
                    {text:order.orderTaking.freight,style:'table'},
                    {text:'',style:'table'},
                    {text:'',style:'table'},
                    {text:order.orderTaking.safes,style:'table'},
                    {text:'',style:'table'}]);
                bodyarry.push([
                    {text:'回单要求',style:'table',colSpan: 3},
                    {},
                    {},
                    {text:'回单份数',style:'table',colSpan: 3},
                    {},
                    {},
                    {text:'费用合计',style:'table'},
                    {text:'现付',style:'table'},
                    {text:'到付',style:'table'},
                    {text:'回付',style:'table'},
                    {text:'月结',style:'table'}]);
                bodyarry.push([
                    ...
                    {},]);
                bodyarry.push([
                    {text:'备注：',style:'table',colSpan: 3},
                    {},
                    {},
                    {text:'温馨提示：\n您的签名表明您已理解本运单及法律含义并接受其约定。\n\n托运人签署：',style:'table',colSpan: 4},
                    {},
                    {},
                    {},
                    {
                        columns:[
                            [
                                ...
                                {text:'收货人证件号码：',style:'table'},
                            ],
                        ],
                        style:'table',colSpan: 4
                    },
                    {},
                    {},
                    {},]);
            ...
            pdfInit(order){
                this.pdfData = {
                    ...
                    content: [
                        ...
                        { text: '托运单', style: 'title'},
                        { text: 'NO:'+order.order.order_number, style: 'title2'},
                        {
                            table: {
                                widths:[55,55,55,55,55,55,65,65,65,65,'*'],
